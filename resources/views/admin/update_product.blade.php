...
<div class="container">  
  ...
  <form id="contact" action="{{url('/update_product_confirm', $product->id)}}" method="POST" enctype="multipart/form-data">
    @csrf
    ...
    <fieldset>
      <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Update Product</button>
    </fieldset>
  </form>
</div>
