...
<div class="container">  
  ...
  <form id="contact" action="{{url('/add_product_sold')}}" method="POST" enctype="multipart/form-data">
    @csrf
    <h3>Add the Product sold</h3>
    <br>
    <br>
    <fieldset>
    ...
    <br>
    <fieldset>
      <input placeholder="the Quantitiy sold" name="quantity_sold" required=""  min="0" type="number" tabindex="1" required autofocus>
    </fieldset>
    <br>
    <fieldset>
    ...
    <fieldset>
      <button name="submit" type="submit" id="contact-submit" data-submit="...Sending">Add the Product sold</button>
    </fieldset>
  </form>
</div>
